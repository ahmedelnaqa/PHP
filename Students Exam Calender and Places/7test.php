...
<body>
  ...
  تم الانتهاء من رفع جداول المستوى الثانى ساعات معتمدة,المستوى الثالث ساعات معتمدة والمستوى الرابع ساعات معتمدة فقط 
</div>
...
<p>يجب كتابه 14 رقم او رقم الباسبور للمغتربين</p>
  ...
  $db = mysqli_connect($servername, $username, $password, $dbname);
            ...
            // Search for stylist
            $sql = "SELECT * FROM st WHERE field9 = '$styid'";
       
            $result = mysqli_query($db,$sql);
			
			// read the name only:
			$sql1 = "SELECT field3,field4,field9 FROM st WHERE field9 = '$styid'";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo '<thead class="table-dark"><tr><th>التاريخ</th><th>المادة</th><th>الفترة</th><th>مكان اللجنة</th><th>رقم اللجنة</th><th>مكان المقعد</th><th>الفرقه/المستوى</th></tr></thead><tbody class="table-group-divider">';
				//<th>سكشن</th>
